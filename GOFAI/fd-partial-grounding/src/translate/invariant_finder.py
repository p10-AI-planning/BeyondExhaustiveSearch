...
class BalanceChecker:
    def __init__(self, task, reachable_action_params):
        ...
        for act in task.actions:
            ...
            if create_heavy_act:
                heavy_act = gofai_pddl.Action(action.name, action.parameters,
    ...
    def add_inequality_preconds(self, action, reachable_action_params):
        ...
        if inequal_params:
            ...
            for pos1, pos2 in inequal_params:
                ...
                new_cond = gofai_pddl.NegatedAtom("=", (param1, param2))
                precond_parts.append(new_cond)
            precond = gofai_pddl.Conjunction(precond_parts).simplified()
            return gofai_pddl.Action(
